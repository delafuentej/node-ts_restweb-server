...
import { CreateTodoDto, UpdateTodoDto } from "../../../src/domain";

describe('todo.repository.ts: testing TodoRepository', ()=> {

    const newTodo =  new TodoEntity(1,'testing todo-repository')

   
    class MockTodoDatasource implements TodoRepository{
